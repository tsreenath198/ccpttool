...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren:
          "./client-call-history/client-call-history.module#ClientCallHistoryModule"
      },
      {
        path: "client-application",
        loadChildren:
          "./client-application/client-application.module#ClientApplicationModule"
      },
      // tslint:disable-next-line:max-line-length
      {
        path: "client-application-status",
        loadChildren:
          "./client-application-status/client-application-status.module#ClientApplicationStatusModule"
      },
      {
        path: "client-position",
        loadChildren:
          "./client-position/client-position.module#ClientPositionModule"
      },
      {
        path: "client-position-status",
        loadChildren:
          "./client-position-status/client-position-status.module#ClientPositionStatusModule"
      },
      {
        path: "consultant",
      ...
      },
      {
        ...
        loadChildren:
          "./consultant-call-history/consultant-call-history.module#ConsultantCallHistoryModule"
      },
      {
        path: "consultant-status",
        loadChildren:
          "./consultant-status/consultant-status.module#ConsultantStatusModule"
      },
      {
        path: "recruiter",
      ...
      { path: "client", loadChildren: "./client/client.module#ClientModule" },
      {
        path: "email-template",
        loadChildren:
          "./email-template/email-template.module#EmailTemplateModule"
      },
      {
        path: "message-template",
        loadChildren:
          "./message-template/message-template.module#MessageTemplateModule"
      },
      {
        path: "payments",
