export class URLConstants {
  ...
  CPEmptyPostings = 'clientPosition/getEmptyData';
  ...
  /**Industry Type */
  ITCreate = 'industryType';
  ITGetAll = 'industryType/?pageNo=';
  ITUpdate = 'industryType';
  ITDelete = 'industryType/';
  ITGetById = 'industryType/';
