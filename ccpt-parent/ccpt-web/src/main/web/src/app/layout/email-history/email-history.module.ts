...
@NgModule({
    imports: [CommonModule,NgxPaginationModule, EmailHistoryRoutingModule, FormsModule,NgbModule, PageHeaderModule, SharedPipesModule, AngularEditorModule, ActionListModule],
