...
INSERT INTO email_template (id, active_flag, created_date, description, updated_date, subject, type) VALUES (NULL, b'1', NULL, 'We at Talent Corner Hr Services is having an exciting Oppournity for one of our client in ${sector} at ${joblocation} ${jobDescription} ${jobSpecification} Interested Candidates are required to send their updated resume on ${emailid} or you can also reach us on ${phone} Kindly also mention following details 1. Current CTC 2. Expected CTC 3. Notice Period Regards Your Signature. ', NULL, 'Urgent Opening/Excellent Oppournity for ${role} at ${joblocation}', 'MassMailing');
INSERT INTO email_template (id, active_flag, created_date, description, updated_date, subject, type) VALUES (NULL, b'1', NULL, 'Hi ${contactName} ${salutation}, I wanted to speak to you regarding ${role} for location ${location}. But couldn’t reach you on your phone. Request you to provide me the appropriate time so that we can have a quick call. You can always call me at +91 98480 71296 Regards, Sreenath Thatikonda Talent Corner HR Service Pvt Ltd Ph : +91 98480 71296 Email : sreenath.t@talentcorner.in ', NULL, 'Regd${role} at ${location}', 'Not Reachable');
INSERT INTO email_template (id, active_flag, created_date, description, updated_date, subject, type) VALUES (NULL, b'1', NULL, 'Hi ${contactName} ${salutation}, As discussed over the phone, wanted to put all my questions over an email about the ${role} for location ${location}. ${questions} Please revert back to me with all the necessary answers at your convenience. Regards, Sreenath Thatikonda Talent Corner HR Service Pvt Ltd Ph : +91 98480 71296 Email : sreenath.t@talentcorner.in ', NULL, 'Questions regd${role} at ${location}', 'Questions');
INSERT INTO email_template (id, active_flag, created_date, description, updated_date, subject, type) VALUES (NULL, b'1', NULL, 'Hi ${contactName} ${salutation}, Hope you are doing good. We have shortlisted ${noOfCandidates} candidates (CVs attached) for ${role} at ${location}. Kindly review them and provide necessary feedback. Designation :${role} ${repeat for each candidate} 1. ${FullName} Current Designation :${currentDesignation} Current Organization :${currentCompany} Current CTC :${currentCTC} Total Exp :${totalExp} InHand CTC- 3L ECTC- 5L InHand ECTC- 4.8L Residing Location– Wadala Any Offer- Yes for 4.25 Notice Period- 15 days Verify and let me know if any of this profile suits you Regards, Sreenath Thatikonda Talent Corner HR Service Pvt Ltd Ph : +91 98480 71296 Email :sreenath.t@talentcorner.in Attach resumes ', NULL, 'Shortlised CVs for${role} at ${location}', 'Shortlist');
INSERT INTO email_template (id, active_flag, created_date, description, updated_date, subject, type) VALUES (NULL, b'1', NULL, 'Hi ${contactName} ${salutation}, Hi ${contactName}${salutation}, Please find below the interview details for the ${role} at ${location} Interview Date&Time :${interviewDate}${Time} Interview Mode :${Mode} Candidate :${consultantName} Things to Remember: 1. Mobile silent 2. Reach 30 mins early 3. Copies of all necessary certificates / proofs 4. Interview confirmation letter 5. Format Dress code and Dress up well Regards, Sreenath Thatikonda Talent Corner HR Service Pvt Ltd Ph : +91 98480 71296 Email :sreenath.t@talentcorner.in Attach resumes', NULL,'Interview Confirmation for ${role} at ${location}','Interview Confirmation');
INSERT INTO email_template (id, active_flag, created_date, description, updated_date, subject, type) VALUES (NULL, b'1', NULL, 'Hi ${contactName} ${salutation}, Hope the interview went well with ${consultant} for ${role}. Please provide your valuable feedback for the same. Regards, Sreenath Thatikonda Talent Corner HR Service Pvt Ltd Ph : +91 98480 71296 Email :sreenath.t@talentcorner.in ', NULL, 'Feedback for the Interview', 'Interview Feedback');

INSERT INTO sms_template (id, active_flag, created_date, description, updated_date, type) VALUES (NULL, b'1', '2019-06-12 09:47:49', 'Sir, Sreenath here from TalentCorner. Tried calling you about ${role}. Let me know the right time to speak or call me @ +919848071296.', '2019-06-12 09:47:49', 'not reachable');
